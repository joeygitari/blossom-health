...
const options = {
    ...
    labels: ['Surgery', 'Therapy', 'Others', 'Endoscopy'],
    legend: {
        show: false,
        position: 'bottom',
    },
                ...
                <div>
                    <div className="relative z-20 inline-block">
                        <select
                            name=""
                            id=""
                            className="font-poppins relative z-20 inline-flex appearance-none bg-transparent py-1 pl-3 pr-8 text-sm font-medium border-none"
                        >
